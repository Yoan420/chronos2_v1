...
def main():
    ...
    parser.add_argument('--input', type=Path, default=Path('research/tensor_timesfm_20260915/metrics/verified_hourly_pairs.csv.gz'))
    parser.add_argument('--output-dir', type=Path, default=Path('research/tensor_timesfm_20260915/compression'))
