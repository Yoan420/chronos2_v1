"""Verified baseline reuse for the approved frozen DE/NL corrector ablation."""
...
def main():
    ...
    from chronos2_hourly.solar_wind_corrector_reuse import run
    return run(action=args.action, zones=args.zones, threads=args.threads,
