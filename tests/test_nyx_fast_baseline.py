...
from chronos2_hourly import nyx_fast_baseline as m
...
def test_prepare_isolated_sources_extra_wind_stays_outside_core(monkeypatch, tmp_path, recipe):
    ...
    identity = {'zone': 'DE', 'delivery_day': '2026-09-24', 'run_id': 'synthetic',
        'source_records': sources, 'threads': 1, 'residual_threads': 2, 'interaction_builder': {}, 'history_anchor_day': '2024-09-10'}
