...
print("[Nuclear] ECHEC : Saturn ProxyError: HTTPSConnectionPool(host='saturn.fixture.invalid', port=443): ProxyError('Unable to connect to proxy', NewConnectionError(HTTPConnection(host='127.0.0.1', port=9): connection refused))", flush=True)
