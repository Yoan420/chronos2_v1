...
for x,w,c,label in [(0,4.93,'#c8d4da','Initial 180 days'),(4.93,2.6,'#dbe2e6','Validation 95 days'),(7.53,2.47,'#eceff1','Reserved 90 days')]:
    ax.barh(.95,w,left=x,height=.48,color=c,edgecolor='white');ax.text(x+w/2,.95,label,ha='center',va='center',fontsize=9)
ax.text(0,.35,'16 Sep 2025',ha='left',fontsize=8.5); ax.text(4.93,.35,'15 Mar 2026',ha='center',fontsize=8.5);ax.text(7.53,.35,'18 Jun 2026',ha='center',fontsize=8.5);ax.text(10,.35,'15 Sep 2026',ha='right',fontsize=8.5)
save('figure1_design')
...
for z,ax in zip(zones,axes.flat):
    ...
    ax.set_title(z,loc='left',fontsize=11);ax.grid(axis='y',alpha=.2);ax.set_xticks([0,3,6,9,12],['Sep 25','Dec','Mar 26','Jun','Sep 26']);ax.tick_params(axis='x',labelsize=8)
